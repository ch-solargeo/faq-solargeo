  ...
  try {
    ...
    const emailResponse = await fetch('https://api.brevo.com/v3/smtp/email', {
      ...
      body: JSON.stringify({
        ...
        htmlContent: '<h2 style="color:#2b230f;font-family:Arial,sans-serif;">Nouveau message depuis la FAQ SOLARGEO</h2><table style="border-collapse:collapse;width:100%;max-width:600px;font-family:Arial,sans-serif;"><tr style="background:#fff9e6;"><td style="padding:12px 16px;border:1px solid #eee;font-weight:bold;width:180px;">Prénom</td><td style="padding:12px 16px;border:1px solid #eee;">' + prenom + '</td></tr><tr><td style="padding:12px 16px;border:1px solid #eee;font-weight:bold;">Nom</td><td style="padding:12px 16px;border:1px solid #eee;">' + nom + '</td></tr><tr style="background:#fff9e6;"><td style="padding:12px 16px;border:1px solid #eee;font-weight:bold;">Zone</td><td style="padding:12px 16px;border:1px solid #eee;">' + zone + '</td></tr><tr><td style="padding:12px 16px;border:1px solid #eee;font-weight:bold;">Ville</td><td style="padding:12px 16px;border:1px solid #eee;">' + (ville || "Non renseignée") + '</td></tr><tr style="background:#fff9e6;"><td style="padding:12px 16px;border:1px solid #eee;font-weight:bold;">Email</td><td style="padding:12px 16px;border:1px solid #eee;"><a href="mailto:' + email + '">' + email + '</a></td></tr><tr><td style="padding:12px 16px;border:1px solid #eee;font-weight:bold;">Message</td><td style="padding:12px 16px;border:1px solid #eee;">' + (message || "Aucun message") + '</td></tr></table>'
      })
    });
